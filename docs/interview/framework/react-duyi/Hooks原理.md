...
<img src="../images/2023-03-03-031041.png" alt="image-20230303111041259" style="zoom:50%;" />
...
<img src="../images/2023-03-03-072611.png" alt="image-20230303152610928" style="zoom:50%;" />

第二次复用的时候，发现 hook 的类型不同， useState !==useRef，那么就会直接报错。因此开发的时候一定要注意 hook 顺序的一致性。

<img src="../images/2023-03-03-031320.jpg" alt="16717800284171" style="zoom: 33%;" />
